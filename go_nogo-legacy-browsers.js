...
function wel1RoutineBegin(snapshot) {
  return async function () {
    ...
    wel1Components.forEach( function(thisComponent) {
...
function wel2RoutineBegin(snapshot) {
  return async function () {
    ...
    wel2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function fixationpra1RoutineBegin(snapshot) {
  return async function () {
    ...
    fixationpra1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function stimuluspra1RoutineBegin(snapshot) {
  return async function () {
    ...
    stimuluspra1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function endpra1RoutineBegin(snapshot) {
  return async function () {
    ...
    endpra1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function endpra2RoutineBegin(snapshot) {
  return async function () {
    ...
    endpra2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
